...
<!--                                 </li> -->
  ...
  <nav class="blog-pagination justify-content-center d-flex">
					...
					[이전]&nbsp;
						<%} else { %>
						<li class="page-item"><a href="review.al?lecture=jsp&page=<%=nowPage -1 %>">[이전]</a></li>
						<%} %>
			...
			if(i == nowPage) {%>
				[<%=i %>]
			<%} else { %>
				<li class="page-item active"><a href = "review.al?lecture=jsp&page=<%=i %>">[<%=i %>]</a></li>
			<%} %>
		<%} %>
		...
		<%if(nowPage >= maxPage){ %>
			&nbsp;[다음]
		<%} else {  %>
			 <li class="page-item"><a href="review.al?lecture=jsp&page=<%=nowPage +1 %>">[다음]</a></li>
		<%} %>
