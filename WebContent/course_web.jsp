...
<!--                                 </li> -->
					...
					[이전]&nbsp;
						<%} else { %>
						<li class="page-item"><a href="review.al?lecture=web&page=<%=nowPage -1 %>">[이전]</a></li>
						<%} %>
			...
			if(i == nowPage) {%>
				[<%=i %>]
			<%} else { %>
				<li class="page-item active"><a href = "review.al?lecture=web&page=<%=i %>">[<%=i %>]</a></li>
			<%} %>
		<%} %>
		...
		<%if(nowPage >= maxPage){ %>
			&nbsp;[다음]
		<%} else {  %>
			 <li class="page-item"><a href="review.al?lecture=web&page=<%=nowPage +1 %>">[다음]</a></li>
		<%} %>
                    ...
                    <ul>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
                                <p>교육과정</p>
                                <span class="or">웹표준(html5, css3)</span>
                            </a>
                        </li>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
