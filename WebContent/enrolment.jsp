            ...
            <div class="clearfix lecture-select lecture-select-depth-3">
                ...
                <div class="select-division">
                    ...
                    <ul class="lecture-select-area lecture-select-subject" id="select_subject">
                                            <li class="active"><a href="#none" data-idx="0">JAVA</a></li>
                                            <li class=""><a href="#none" data-idx="1">ORACLE</a></li>
                ...
                <div class="select-division">
                    ...
                    <ul class="lecture-select-area lecture-select-day" id="select_day">
                                            <li class="active"><a href="#none" data-idx="0">월,수,금</a></li>
                                            <li class=""><a href="#none" data-idx="1">화,목</a></li>
                                            <li class=""><a href="#none" data-idx="2">주말반</a></li>
                                        </ul>
                </div>
                ...
                <div class="select-division">
                    ...
                    <ul class="lecture-select-area lecture-select-time" id="select_time">
                                            ...
                                            <li><a href="#none" data-idx="1">평일 오후</a></li>
                                            <li><a href="#none" data-idx="2">평일 저녁</a></li>
                                            <li><a href="#none" data-idx="3">주말 종일</a></li>
                                        </ul>
                </div>
...
// 			// 교재 자세히보기 팝업 이벤트
// 			$(document).on('click', '.btn-popup-textbook', function () {
// 				var saleinfo_id = $(this).data('saleinfo_id');
// 				app.book_detail(saleinfo_id);
// 		    });
...
// 		    });
		...
		select_subject : function(category_1st){
			...
			category.category_2nd = 0; //단과
			category.category_3rd = 0; // 수업요일 첫번째
			category.category_4th = 0; // 수업시간 첫번째
			_ajax({type:'POST', url:'/enrolment.le', data:{'category' : category}});
		},
		select_day : function(category_3rd){
			click_type = 'day';
			category.category_3rd = category_3rd; //수업요일 선택
			category.category_4th = 0; // 수업시간 첫번째
			_ajax({type:'POST', url:'/enrolment.le', data:{'category' : category}});
		},
		select_time : function(category_4th){
			click_type = 'time';
			category.category_4th = category_4th; // 수업시간 선택
			_ajax({type:'POST', url:'/enrolment.le', data:{'category' : category}});
		}
	}
}
