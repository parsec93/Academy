...
<%
    ...
    String bdFileName = request.getParameter( "bd_File_name" );
	 System.out.println(bdFileName);
     String savePath = "boardUpload";
     ServletContext context = getServletContext();
     String sDownloadPath = context.getRealPath(savePath);
     String sFilePath = sDownloadPath + "\\" + bdFileName; // 물리적인 경로\\파일이름
   ...
   if(ie) {
	  sEncoding = URLEncoder.encode(bdFileName, "utf-8").replaceAll("\\+", "%20");
	  System.out.println(sEncoding);
   }else{
	  sEncoding = new String(bdFileName.getBytes("utf-8"),"8859_1");
	  System.out.println(sEncoding);
  }
