...
public class BoardListService {
    ...
    public int getBoardListCount(String board_id, String search) throws Exception {
        ...
        listCount = boardDAO.selectListCount(board_id, search);
//        System.out.println(listCount);
    ...
    // 전체 게시물 목록을 조회하여 리턴
    public ArrayList<BoardBean> getArticleList(int page, int limit,String board_id,String search) throws Exception {
        ...
        articleList = boardDAO.selectArticleList(page, limit,board_id,search);
