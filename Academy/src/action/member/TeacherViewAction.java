...
public class TeacherViewAction implements Action {
    ...
    public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        MemberBean teacher = teacherViewService.getTeacher(member_teacher_code);
        ...
        forward.setPath("admin/teacherview.jsp?member_teacher_code="+member_teacher_code); // 포워딩 주소 지정
